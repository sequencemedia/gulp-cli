...
describe('--gulpfile', () => {
  describe('With a valid gulpfile file path', () => {
    ...
    describe('With a current working directory', () => {
      it('prints the gulpfile file path', (done) => {
        exec('node ./bin/gulp.mjs --gulpfile ./test/mocks/flags/gulpfile/gulpfile.mjs --cwd ./test/mocks/common', (e, stdout) => {
          try {
            expect(e)
              .to.be.null
    ...
    describe('Without a current working directory', () => {
      it('prints the gulpfile file path', (done) => {
        exec('node ./bin/gulp.mjs --gulpfile ./test/mocks/flags/gulpfile/gulpfile.mjs', (e, stdout) => {
          try {
            expect(e)
              .to.be.null
  ...
  describe('With an invalid gulpfile file path', () => {
    ...
    describe('With a current working directory', () => {
      it('throws', (done) => {
        exec('node ./bin/gulp.mjs --gulpfile ./test/gulpfile.mjs --cwd ./test/mocks/common', (e, stdout, stderr) => {
          try {
            expect(e)
    ...
    describe('Without a current working directory', () => {
      it('throws', (done) => {
        exec('node ./bin/gulp.mjs --gulpfile ./test/gulpfile.mjs', (e, stdout, stderr) => {
          try {
            expect(e)
              .to.be.instanceOf(Error)
